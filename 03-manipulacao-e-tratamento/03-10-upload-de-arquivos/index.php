...
vardump([
    "filesize" => ini_get("upload_max_filesize"), // tamanho max de um arquivo aceito
    "postsize" => ini_get("post_max_size") // tamanho max de todos os dados do post
]);
...
vardump(scandir(__DIR__."/uploads"));